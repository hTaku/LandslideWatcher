...
#            print("\u001B[2A", end="")
    ...
    def __printProgress(self, total, now, filename, prefix=''):
        msg = prefix + '[' + str(int((now/total) * 100)) + '%]:' + str(now) + '/' + str(total) + ': ' + filename
        if self.__logger == None:
            print(msg)
        else:
